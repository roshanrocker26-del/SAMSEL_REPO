...
urlpatterns = [
    ...
    path('request-demo-page/', views.request_demo_page, name='request_demo_page'),
    ...
    path('admin/delete-school-purchases/<str:school_id>/', views.delete_school_purchases_admin, name='delete_school_purchases_admin'),
